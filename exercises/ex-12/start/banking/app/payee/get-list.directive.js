/*
 * Build a directive, gs-get-list which does the following:
 * Populates a select list with elements from a data set
 * You could pass gs-get-list states, or cities, or another data set
 ...
 *
 * Finally, go to payee-search-tpl.html to use the directive
 *
 */
(function( angular ) {
