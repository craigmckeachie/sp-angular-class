(function( angular ) {
  /*
   * Objectives
   * * Change payee-main's template to load a payee-list component
   * * Have payee-list require payee-main
   * * Have payee-list load Payees from payee-main via $onInit
   *
   * Delete the line where the results of calling getPayees() are
   * assigned to the controller
   * Move the selectPayee() code over to the Payee list component when it is ready
   * Expose the getPayees() function on the controller
   * so that Payee list can call it
   *
   * Then go to payee-list.component.js
   *
