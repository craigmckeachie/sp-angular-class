(function( angular ) {
  /*
   * Objectives
   * * Create a bindings configuration which expects a list of Payees
   * * Build a PayeeDetail component which expects a Payee
   * * Clicking on a list Payee should pass it to the PayeeDetail component
   *
   * You do not have to make changes here. All your changes will be in
   * payee-list.component.js and following. Go there now.
   *
