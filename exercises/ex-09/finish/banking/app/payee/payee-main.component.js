(function( angular ) {
  /*
   * Add an $onInit lifecycle function to check to see if the route is payees.detail
   * but there is not a defined payee. If so, grab the desired payee id from
   * the $stateParams and use it to match a payee in ctrl.payees.
   * Set the match to ctrl.payee
   *
  ...
  function PayeeMainController( $log, $state, $stateParams ) {
    var ctrl = this;
