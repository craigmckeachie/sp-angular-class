describe( 'Testing tx.component.js', function() {
  var component, fakeDAO, scope, tx, $componentController;

  beforeEach( function() {
    module( 'tx.component' );
    angular.module( 'tx.dao', [] );
  } );
  ...
  beforeEach( inject( function( $rootScope, _$componentController_, $q ) {
    ...
    fakeDAO = {
      get: jasmine.createSpy( 'fakeDAOget' ).and.callFake( function() {
        return $q( function( resolve, reject ) {
          resolve( getTxs()[ 0 ] );
        } )
      } ),

      query: jasmine.createSpy( 'fakeDAOquery' ).and.callFake( function() {
        return $q( function( resolve, reject ) {
          resolve( getTxs() );
        } )
      } )
  ...
  it( 'should query the DAO', function() {
    component = $componentController( 'txComponent', { txDAO: fakeDAO } );
    component.search( { categoryId: 19 } );
    expect( fakeDAO.query ).toHaveBeenCalled();
  } );
